import CREDICARD_ZERO from '../../constants/CREDICARD_ZERO';
...
describe('Credicard ZERO Indicated Page Integration Tests', () => {
  it('should go through the card acquisition flow', () => {
    ...
    cy.get(PAGEINTRO_TITLE.ID).should('contain', PAGEINTRO_TITLE.CONTENT);

    cy.get(PAGEINTRO_LISTITEM_0.ID)
      .should('contain', PAGEINTRO_LISTITEM_0.TEXT1)
      .should('contain', PAGEINTRO_LISTITEM_0.TEXT2);
    cy.get(PAGEINTRO_LISTITEM_1.ID)
      .should('contain', PAGEINTRO_LISTITEM_1.TEXT1)
      .should('contain', PAGEINTRO_LISTITEM_1.TEXT2);
    ...
    cy.contains(BENEFITCARD_0.TEXT);
    ...
    cy.get(BENEFITCARD_3.ID).should('contain', BENEFITCARD_3.TITLE);
    cy.contains(BENEFITCARD_3.TEXT);
    ...
    cy.get(PRODUCTDETAIL_4.ELEMENT).should('contain', PRODUCTDETAIL_4.TEXT1);
    ...
    cy.get(LINK_NAV_MENU_3.ID).should('contain', LINK_NAV_MENU_3.CONTENT);
    cy.get(LINK_NAV_MENU_3.ID).click();
